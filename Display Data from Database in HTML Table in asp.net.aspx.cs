        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                using (SqlCommand scmd = new SqlCommand())
                {
                    ...
                    htmlTable.Append("<tr><th>EID</th><th>EName</th><th>ESalary</th><th>EHireDate</th><th>EDeptId</th></tr>");
                    ...
                    if (articleReader.HasRows)
                    {
                        while (articleReader.Read())
                        {
                            ...
                            htmlTable.Append("<td>" + articleReader["Salary"] + "</td>");
                            htmlTable.Append("<td>" + articleReader["HireDate"] + "</td>");
                            htmlTable.Append("<td>" + articleReader["DeptNo"] + "</td>");
                            htmlTable.Append("</tr>");
                        }
