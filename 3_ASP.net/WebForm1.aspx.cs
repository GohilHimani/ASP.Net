...
namespace WebApplication1
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd=new SqlCommand();
            cmd.CommandText = "Insert into Emp([Id],[Name],[Salary],[Hiredate],[DeptNO]) Value(@Id,@Name,@Salary,@Hiredate,@DeptId)";
            cmd.Parameters.AddWithValue("@Id", Convert.ToInt32(txtID.Text));
            cmd.Parameters.AddWithValue("@Name", txtID.Text);
            cmd.Parameters.AddWithValue("@Salary", Convert.ToInt32(txtID.Text));
            cmd.Parameters.AddWithValue("@HireDate", DateTime.ParseExact(txtHireDate.Text,"dd/mm/yyyy",null));
            cmd.Parameters.AddWithValue("@DeptNo", txtID.Text);
